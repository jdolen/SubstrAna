...
process.Options = cms.PSet(
   ...
   InputInformationParam =  cms.VPSet(
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_mraw_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{raw}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("mraw")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_mclean_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{clean}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("mclean")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_mconst_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{const}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("mconst")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_mpruned_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{pruned}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("mpruned")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_msoftbeta00_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{soft}(#beta=0)"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("msoftbeta00")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_msoftbeta10_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{soft}(#beta=1)"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("msoftbeta10")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_msoftbeta20_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{soft}(#beta=2)"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("msoftbeta20")),
    cms.PSet( fileName = cms.string("SingleVariablesTraining_highPT_lowPU_BDTG/outputTMVATraining_highPT_lowPU/TMVATrainingResult_mtrim_PTBin_475_600_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("M_{trimmed}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("mtrim")),
